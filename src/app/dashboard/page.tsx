  ...
  return (
    <div dir="rtl" style={{ minHeight: "100vh", background: "#f6f9fc", fontFamily: "'Segoe UI', Arial, sans-serif" }}>
      ...
      <div style={{ background: "linear-gradient(135deg, #0B1E3D 0%, #0E7C86 100%)", padding: "24px 20px 40px", color: "#fff" }}>
        ...
        <p style={{ fontSize: 13, color: "rgba(255,255,255,0.7)", marginBottom: 20 }}>مرجع الطبيب العام وطبيب الامتياز</p>
      ...
      <div style={{ padding: "0 16px", marginTop: -16 }}>
        <div style={{
          ...
          {offlineReady
            ...
            : "📶 تلميح: افتح الموقع مرة وأنت متصل بالنت — بعدها كل المحتوى هيتحفظ تلقائياً وتقدر تشتغل أوفلاين"}
        </div>
