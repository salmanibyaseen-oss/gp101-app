...
const FEATURES = [
  ...
  { icon: "📝", title: "ملاحظاتك معاك", desc: "أضف notes شخصية على أي موضوع" },
  { icon: "📵", title: "يشتغل بدون نت", desc: "بعد أول فتح — المحتوى محفوظ عندك" },
  { icon: "🔒", title: "حسابك الخاص", desc: "تسجيل دخول آمن وخاص بيك" },
  { icon: "📱", title: "موبايل + كمبيوتر", desc: "شغّاله على أي جهاز (جهازين لكل مستخدم)" },
  { icon: "⚡", title: "سريع وخفيف", desc: "تصميم مُحسَّن للاستخدام السريع في الشغل" },
];

const STEPS = [
  { num: "١", text: "سجّل دخولك بالبريد وكلمة المرور" },
  { num: "٢", text: "اختار التخصص من القائمة الجانبية" },
  { num: "٣", text: "افتح الموضوع اللي محتاجه" },
  { num: "٤", text: "أضف ملاحظاتك الشخصية لو حابب" },
  { num: "٥", text: "أوفلاين؟ بعد أول فتح كل المحتوى محفوظ" },
];
...
// ── Book cover mimicking the actual PDF cover ─────────────────────────────
function BookCover() {
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: 14, color: "#e53935", fontWeight: 800, fontStyle: "italic", marginTop: 2 }}>
          E-guide
        </div>
      </div>
...
// ── Animated phone showing PDF pages ─────────────────────────────────────
function PhoneMockup() {
  ...
  return (
    <div style={{
      width: 150, height: 270, borderRadius: 22,
      background: "#111827",
      ...
      <div style={{
        ...
        <div style={{
          ...
          fontSize: 8, color: "rgba(255,255,255,0.8)", fontWeight: 700, letterSpacing: 1,
          marginBottom: 6,
        }}>
        ...
        {/* Title */}
        <div style={{ fontSize: 18, fontWeight: 900, color: "#fff", lineHeight: 1, marginBottom: 3 }}>
          {p.title}
        </div>
        <div style={{ fontSize: 8, color: "rgba(255,255,255,0.7)", marginBottom: 10 }}>
          {p.sub}
        </div>

        {/* Content lines mimicking sections */}
        {p.sections.map((s, i) => (
          <div key={i} style={{
        ...
        {/* Page indicator */}
        <div style={{
          marginTop: "auto", display: "flex", justifyContent: "center", gap: 4,
        }}>
          {pages.map((_, i) => (
            <div key={i} style={{
              width: i === page ? 12 : 4, height: 4, borderRadius: 2,
...
export default function GP101Landing() {
  ...
  return (
    <div dir="rtl" style={{
      ...
      background: COLORS.offWhite, minHeight: "100vh", color: COLORS.navy,
    }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          background: "rgba(14,124,134,0.15)", pointerEvents: "none",
        }} />
        ...
        <div style={{
          ...
          padding: "6px 16px", marginBottom: 28, backdropFilter: "blur(4px)",
        }}>
        ...
        <h1 style={{
          ...
          lineHeight: 1.2, margin: "0 0 16px", letterSpacing: -0.5,
        }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          <button style={primaryBtn}>ابدأ الاستخدام الان →</button>
          <button style={outlineBtn}>تعرف على الكتاب 📖</button>
        </div>
      ...
      <div style={{
        ...
        <div style={{
          display: "flex", gap: 32, padding: "0 20px",
      ...
      <section style={{ padding: "64px 24px", maxWidth: 900, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: 2, color: COLORS.teal, textTransform: "uppercase" }}>
            ليه GP101؟
          </span>
          <h2 style={{ fontSize: 28, fontWeight: 800, margin: "10px 0 0" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {STEPS.map((s, i) => (
              <div key={i} style={{
                ...
                padding: "16px 20px", borderRight: `3px solid ${COLORS.teal}`,
              }}>
                <div style={{
      ...
      <section style={{ padding: "64px 24px", maxWidth: 960, margin: "0 auto" }}>
        <div style={{
          ...
          flexWrap: "wrap", border: `1px solid ${COLORS.grayLight}`,
        }}>
          ...
          <div style={{ flex: 1, minWidth: 240 }}>
            <span style={{
              ...
              📚 كتيب مجاني مرفق لفتره محدوده
            </span>
            <h2 style={{ fontSize: 24, fontWeight: 800, margin: "10px 0 8px", color: COLORS.navy }}>
              Clinical Examination E-guide
            </h2>
            <p style={{
              fontSize: 14, color: "#0d47a1", fontWeight: 600,
              background: "#e3f2fd", borderRadius: 8, padding: "6px 12px",
              display: "inline-block", marginBottom: 12,
            }}>
              بقلم: د. سلمان إبراهيم ياسين — جامعة الدلتا
            </p>
            <p style={{ fontSize: 14, color: COLORS.gray, lineHeight: 1.7, marginBottom: 16 }}>
              ملف PDF مُصمَّم باحترافية يضم أكثر من <strong>10 فحوصات إكلينيكية</strong> مختصرة
              ومنهجية — تقدر تطبقها في المستشفى أو أثناء الامتحانات العملية.
              يشمل: Cardiac، Respiratory، Abdominal، Neurological (CN/UL/LL)،
              Musculoskeletal، GYN، Obstetrics، Pediatrics وغيرها.
            </p>
            ...
            <div style={{
              ...
              color: "#795548", lineHeight: 1.6, marginBottom: 16,
            }}>
            ...
            <div style={{
              ...
              padding: "16px 20px", fontSize: 13, color: COLORS.navy, lineHeight: 1.9,
              ...
              <div style={{ color: COLORS.gray, fontSize: 11, marginTop: 4 }}>
                تواصل معنا عبر صفحاتنا على السوشيال ميديا
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{
        ...
        color: COLORS.white, textAlign: "center", padding: "60px 24px",
      }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.7)", marginBottom: 32, fontSize: 15 }}>
          سجّل دلوقتي واستخدم GP101 
        </p>
        <button style={{ ...primaryBtn, fontSize: 16, padding: "16px 40px", boxShadow: "0 8px 32px rgba(0,0,0,0.3)" }}>
          ابدأ الاستخدام →
        </button>
        <div style={{
